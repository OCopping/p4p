...
class TestTable(RefTestCase):
    ...
    def test_unwrap(self):
        ...
        self.assertListEqual(
            P,
            [
                OrderedDict([("a", 5), ("b", "one")]),
                OrderedDict([("a", 6), ("b", "two")]),
            ],
        )
...
class TestArray(RefTestCase):
    ...
    def test_unwrap_mono(self):
        ...
        self.assertTupleEqual(
            pixels.shape, (2, 3)
        )  # inner-most right (in a pixel loop)
    ...
    def test_unwrap_3d(self):
        ...
        assert_aequal(img, pixels)
        self.assertEqual(img.dtype, pixels.dtype)
        self.assertDictEqual(img.attrib, {"ColorMode": 2})  # RGB1
        ...
        self.assertEqual(V2.attribute[0].name, "ColorMode")
