...
"""),
    ...
    def testReserved(self):
        ...
        T2 = V.type()  # ensure Value.type() isn't hidden  # noqa: F841
    ...
    def testArray(self):
        ...
        self.assertListEqual(V.sval, ["a", "b"])
    ...
    def testDisUnion(self):
        ...
        V.x = "world"
        self.assertEqual(V.x, "world")

        # uses previously selected 'b'
        V.x = 128
        self.assertEqual(V.x, "128")
    ...
    def testUnionArray(self):
        ...
        self.assertListEqual(V.x, [1, 4.2, "foo"])
        # magic field selection strikes to convert float -> int
        self.assertListEqual(V.y, [2, 5, "bar"])

        V.y = [("a", 3), ("b", 4.2), ("b", "baz")]

        self.assertListEqual(V.y, [3, "4.2", "baz"])
    ...
    def testBitSetSubStruct(self):
        ...
        self.assertSetEqual(
            A.changedSet(expand=True, parents=False),
            {"z", "z.a", "z.b", "z.q", "z.q.m"},
        )
        # self.assertSetEqual(A.changedSet(expand=False, parents=True),  {'z'})
        self.assertSetEqual(
            A.changedSet(expand=True, parents=True), {"z", "z.a", "z.b", "z.q", "z.q.m"}
        )
        ...
        self.assertSetEqual(
            A.changedSet(expand=True, parents=True), {"z", "z.q", "z.q.m"}
        )
